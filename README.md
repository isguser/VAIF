...
* Assets
	...
	* Resources (which is where you will organize your Agents, Animations, Dialogs, and Scenes)
...
You need to create a Conversation in order to run Events. See Section 6.1 Create a Conversation.
Tutorial Video: https://youtu.be/NRj5FynCpLs
#### Editing the Fields and Settings for General Events
Section 6.3.1 Editing the Fields and Settings of Events
